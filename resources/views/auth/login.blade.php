...
<div class="container-fluid">
    <div class="row ">
     ...
     <img class="imgside" style="" src="assets/img/signside.png" height="657vh" width="100%" alt="">
            ...
            <div style="text-align: center;margin-top:100px">
             ...
             <p style="color: white;font-size:17px">Student Meshaal Club<br>
               ...
               21, 2016.</p>
              <a  style="color: white;font-size:20px;padding:10px;border-radius:30px;background:none;border:2px solid white"  href="{{route('register')}}">Sign In</a>
        ...
        <div class="col-md-8" >
          <a href="/"><img src="assets/img/logo.png" style="float: right;margin:10px;" width="50px" height="60px" alt=""></a>  
            ...
            <h1 style="margin-bottom:60px;" ><b style="border-bottom:2px solid orange;">Sign In</b></h1>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4" style="margin:0 auto;">
